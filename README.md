...
4. 容器里面的代码，被称为 “Vue模板”
5. 新版本 data 只能是“函数式”，旧版本根组件的 data，可以“对象式”，也可以“函数式”，vue-3.4.37.js:1641 [Vue warn]: The data option must be a function. Plain object usage is no longer supported.  at <App>
